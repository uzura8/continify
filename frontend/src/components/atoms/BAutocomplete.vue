  ...
  methods: {
    ...
    checkIfHeaderOrFooterSelected(event, triggerClick, closeDropdown = true) {
      if (
        ...
        (this.headerHovered || (triggerClick && triggerClick.origin === 'header'))
      ) {
      ...
      if (
        ...
        (this.footerHovered || (triggerClick && triggerClick.origin === 'footer'))
      ) {
